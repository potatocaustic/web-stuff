...
const CONFIG = {
  ...
  GAMES: [
    ...
    { name: 'Auburn vs Ball State', teams: ['AUB', 'BallSt'] },
    { name: 'Nebraska vs Akron', teams: ['Neb', 'Akron'] },
    { name: 'Louisville vs James Madison', teams: ['Lou', 'JMU'] },
    { name: 'Washington vs UCDav', teams: ['WAS', 'UCDav'] },
    { name: 'Central Florida vs NCA&T', teams: ['UCF', 'NCA&T'] },
    { name: 'Boise State vs EastWa', teams: ['Boise', 'EastWa'] },
    { name: 'Ohio State vs Gram', teams: ['OSU', 'Gram'] },
    { name: 'LSU vs LaTech', teams: ['LSU', 'LaTech'] },
    { name: 'Buffalo vs StF-Pa', teams: ['BUF', 'StF-Pa'] },
    ...
    { name: 'Wake Forest vs WCU', teams: ['WF', 'WCU'] },
    ...
    { name: 'Colorado State vs NorCol', teams: ['CSU', 'NorCol'] },
    { name: 'Indiana vs KennSt', teams: ['IU', 'KennSt'] },
    { name: 'Georgia Tech vs G-Webb', teams: ['GT', 'G-Webb'] },
    { name: 'Utah vs CalPly', teams: ['UTA', 'CalPly'] },
    { name: 'Florida vs South Florida', teams: ['Fla', 'USF'] },
    { name: 'Coastal Carolina vs ChSou', teams: ['CCU', 'ChSou'] },
    { name: 'Cincinnati vs BGSU', teams: ['CIN', 'BGSU'] },
    { name: 'Wyoming vs UNI', teams: ['WYO', 'UNI'] },
    { name: 'Georgia vs APSU', teams: ['UGA', 'APSU'] },
    { name: 'Maryland vs NIU', teams: ['MD', 'NIU'] },
    { name: 'Wisconsin vs MiddTn', teams: ['Wisc', 'MiddTn'] },
    { name: 'Mississippi vs UK', teams: ['Miss', 'UK'] },
    { name: 'UConn vs Syracuse', teams: ['UCONN', 'Syr'] },
    { name: 'Florida Atlantic vs FlaA&M', teams: ['FAU', 'FlaA&M'] },
    ...
    { name: 'Eastern Michigan vs LIU', teams: ['EMU', 'LIU'] },
    { name: 'Massachusetts vs Bryant', teams: ['UMASS', 'Bryant'] },
    { name: 'UTEP vs TN-Mar', teams: ['UTEP', 'TN-Mar'] },
    { name: 'Tulsa vs NMSt', teams: ['TLSA', 'NMSt'] },
    { name: 'California vs TxSo', teams: ['CAL', 'TxSo'] },
    { name: 'Missouri State vs Marshall', teams: ['Marsh', 'MoStU'] },
    { name: 'North Carolina vs Charlotte', teams: ['UNC', 'Char'] },
    { name: 'Southern Miss vs JkSt', teams: ['USM', 'JkSt'] },
    { name: 'Nevada vs Sac', teams: ['Nev', 'Sac'] },
