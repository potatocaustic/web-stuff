...
GAMES: [
    { name: 'Navy vs Florida Atlantic', teams: ['Navy', 'Florida Atlantic'] },
    { name: 'Old Dominion vs Appalachian State', teams: ['Old Dominion', 'Appalachian State'] },
    { name: 'Ohio vs Eastern Michigan', teams: ['Ohio', 'Eastern Michigan'] },
    { name: 'Mississippi vs Oklahoma', teams: ['Mississippi', 'Oklahoma'] },
    { name: 'Arkansas vs Auburn', teams: ['Arkansas', 'Auburn'] },
    { name: 'Arizona State vs Houston', teams: ['Arizona State', 'Houston'] },
    { name: 'Louisville vs Boston College', teams: ['Louisville', 'Boston College'] },
    { name: 'South Florida vs Memphis', teams: ['South Florida', 'Memphis'] },
    { name: 'SMU vs Wake Forest', teams: ['SMU', 'Wake Forest'] },
    ...
    { name: 'North Texas vs UNC Charlotte', teams: ['North Texas', 'UNC Charlotte'] },
    { name: 'Buffalo vs Akron', teams: ['Buffalo', 'Akron'] },
    { name: 'Delaware vs Middle Tenn. St', teams: ['Delaware', 'Middle Tenn. St'] },
    { name: 'Vanderbilt vs Missouri', teams: ['Vanderbilt', 'Missouri'] },
    { name: 'Oregon vs Wisconsin', teams: ['Oregon', 'Wisconsin'] },
    { name: 'TCU vs West Virginia', teams: ['TCU', 'West Virginia'] },
    { name: 'Kansas State vs Kansas', teams: ['Kansas State', 'Kansas'] },
    { name: 'Alabama vs South Carolina', teams: ['Alabama', 'South Carolina'] },
    { name: 'Virginia vs North Carolina', teams: ['Virginia', 'North Carolina'] },
    { name: 'Washington State vs Toledo', teams: ['Washington State', 'Toledo'] },
    { name: 'Texas Tech vs Oklahoma State', teams: ['Texas Tech', 'Oklahoma State'] },
    { name: 'Utah vs Colorado', teams: ['Utah', 'Colorado'] },
    { name: 'Boise State vs Nevada', teams: ['Boise State', 'Nevada'] },
    { name: 'Georgia Tech vs Syracuse', teams: ['Georgia Tech', 'Syracuse'] },
    { name: 'UConn vs Rice', teams: ['UConn', 'Rice'] },
    { name: 'Rutgers vs Purdue', teams: ['Rutgers', 'Purdue'] },
    { name: 'Texas vs Mississippi State', teams: ['Texas', 'Mississippi State'] },
    { name: 'Tulsa vs Temple', teams: ['Tulsa', 'Temple'] },
    { name: 'Utah State vs New Mexico', teams: ['Utah State', 'New Mexico'] },
    { name: 'Miami vs Stanford', teams: ['Miami', 'Stanford'] },
    { name: 'Iowa State vs BYU', teams: ['Iowa State', 'BYU'] },
    { name: 'Southern Miss vs Louisiana-Monroe', teams: ['Southern Miss', 'Louisiana-Monroe'] },
    { name: 'Wyoming vs Colorado State', teams: ['Wyoming', 'Colorado State'] },
    { name: 'Virginia Tech vs California', teams: ['Virginia Tech', 'California'] },
    { name: 'Texas A&M vs LSU', teams: ['Texas A&M', 'LSU'] },
    { name: 'New Mexico State vs Missouri State', teams: ['New Mexico State', 'Missouri State'] },
    { name: 'Western Kentucky vs Louisiana Tech', teams: ['Western Kentucky', 'Louisiana Tech'] },
    { name: 'Iowa vs Minnesota', teams: ['Iowa', 'Minnesota'] },
    { name: 'Miami (OH) vs Western Michigan', teams: ['Miami (OH)', 'Western Michigan'] },
    { name: 'South Alabama vs Georgia State', teams: ['South Alabama', 'Georgia State'] },
    { name: 'Bowling Green vs Kent State', teams: ['Bowling Green', 'Kent State'] },
    { name: 'Fresno State vs San Diego State', teams: ['Fresno State', 'San Diego State'] },
    { name: 'Michigan vs Michigan State', teams: ['Michigan', 'Michigan State'] },
    { name: 'Ball State vs Northern Illinois', teams: ['Ball State', 'Northern Illinois'] },
    { name: 'Massachusetts vs Central Michigan', teams: ['Massachusetts', 'Central Michigan'] },
    { name: 'Nebraska vs Northwestern', teams: ['Nebraska', 'Northwestern'] }
]
};
