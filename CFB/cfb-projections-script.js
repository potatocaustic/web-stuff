...
const CONFIG = {
  ...
  GAMES: [
    ...
    { name: 'Akron vs Wyoming', teams: ['Akron', 'Wyo'] },
    { name: 'Alabama vs Florida State', teams: ['Alabama', 'FSU'] },
    { name: 'Appalachian State vs UNC Charlotte', teams: ['Appalachian State', 'Char'] },
    ...
    { name: 'Ball State vs Purdue', teams: ['BallSt', 'PUR'] },
    { name: 'Boise State vs South Florida', teams: ['Boise State', 'USF'] },
    { name: 'Boston College vs Ford', teams: ['Boston College', 'Ford'] },
    { name: 'BYU vs PorSt', teams: ['BYU', 'PorSt'] },
    { name: 'California vs Oregon State', teams: ['California', 'ORST'] },
    { name: 'Central Florida vs Jacksonville State', teams: ['Central Florida', 'JacSt'] },
    { name: 'Central Michigan vs San Jose State', teams: ['Central Michigan', 'SJSU'] },
    { name: 'Cincinnati vs Nebraska', teams: ['Cincinnati', 'Neb'] },
    { name: 'Clemson vs LSU', teams: ['Clemson', 'LSU'] },
    { name: 'Coastal Carolina vs Virginia', teams: ['Coastal Carolina', 'UVa'] },
    { name: 'Colorado vs Georgia Tech', teams: ['Colorado', 'GT'] },
    { name: 'Colorado State vs Washington', teams: ['Colorado State', 'UW'] },
    { name: 'Delaware vs DelSt', teams: ['Delaware', 'DelSt'] },
    { name: 'Duke vs Elon', teams: ['Duke', 'Elon'] },
    { name: 'East Carolina vs North Carolina State', teams: ['East Carolina', 'NCSU'] },
    { name: 'Eastern Michigan vs Texas State', teams: ['Eastern Michigan', 'TxSt'] },
    { name: 'Florida vs LIU', teams: ['Florida', 'LIU'] },
    { name: 'Florida Atlantic vs Maryland', teams: ['Florida Atlantic', 'MD'] },
    { name: 'Fresno State vs Georgia Southern', teams: ['Fresno State', 'GaSo'] },
    { name: 'Georgia vs Marsh', teams: ['Georgia', 'Marsh'] },
    { name: 'Georgia State vs Mississippi', teams: ['Georgia State', 'Miss'] },
    { name: 'Illinois vs WestIl', teams: ['Illinois', 'WestIl'] },
    { name: 'Indiana vs Old Dominion', teams: ['Indiana', 'ODU'] },
    ...
    { name: 'Kennesaw State vs Wake Forest', teams: ['Kennesaw State', 'Wake'] },
    { name: 'Kent vs Merrim', teams: ['Kent', 'Merrim'] },
    { name: 'Kentucky vs Toledo', teams: ['Kentucky', 'TOL'] },
    { name: 'Liberty vs Maine', teams: ['Liberty', 'Maine'] },
    { name: 'Louisiana Tech vs SELa', teams: ['Louisiana Tech', 'SELa'] },
    { name: 'Louisiana-Lafayette vs Rice', teams: ['Louisiana-Lafayette', 'Rice'] },
    { name: 'Louisiana-Monroe vs StF-Pa', teams: ['Louisiana-Monroe', 'StF-Pa'] },
    { name: 'Louisville vs EastKy', teams: ['Louisville', 'EastKy'] },
    { name: 'Memphis vs Chat', teams: ['Memphis', 'Chat'] },
    { name: 'Miami vs Notre Dame', teams: ['Miami', 'ND'] },
    { name: 'Miami (OH) vs Wisconsin', teams: ['Miami (OH)', 'Wisc'] },
    { name: 'Michigan vs New Mexico', teams: ['Michigan', 'NM'] },
    { name: 'Michigan State vs Western Michigan', teams: ['Michigan State', 'WestMI'] },
    { name: 'Minnesota vs Buffalo', teams: ['Minnesota', 'Buff'] },
    { name: 'Mississippi State vs Southern Miss', teams: ['Mississippi State', 'SouMis'] },
    ...
    { name: 'Northwestern vs Tulane', teams: ['Northwestern', 'TULN'] },
    { name: 'Ohio vs Rutgers', teams: ['Ohio', 'Rut'] },
    { name: 'Ohio State vs Texas', teams: ['Ohio State', 'Tex'] },
    ...
    { name: 'South Carolina vs Virginia Tech', teams: ['South Carolina', 'VaTech'] },
    { name: 'Temple vs Massachusetts', teams: ['Temple', 'UMass'] },
    { name: 'Tennessee vs Syracuse', teams: ['Tennessee', 'Syr'] },
    { name: 'Texas A&M vs UTSA', teams: ['Texas A&M', 'Tx-SA'] },
    { name: 'Texas Tech vs Ark-PB', teams: ['Texas Tech', 'Ark-PB'] },
    { name: 'UConn vs CentCt', teams: ['UConn', 'CentCt'] },
    { name: 'UNLV vs Sam Houston', teams: ['UNLV', 'SamHou'] },
    { name: 'USC vs MoStU', teams: ['USC', 'MoStU'] },
    { name: 'UTEP vs Utah State', teams: ['UTEP', 'USU'] },
