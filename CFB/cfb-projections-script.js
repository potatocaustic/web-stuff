...
GAMES: [
    ...
    { name: 'Abilene Christian vs Texas Christian', teams: ['Abilene Christian', 'Texas Christian'] },
    { name: 'Air Force vs Utah State', teams: ['Air Force', 'Utah State'] },
    { name: 'Akron vs Alabama-Birmingham', teams: ['Akron', 'Alabama-Birmingham'] },
    ...
    { name: 'Florida vs Louisiana State', teams: ['Florida', 'Louisiana State'] },
    ...
    { name: 'Incarnate Word vs Texas-San Antonio', teams: ['Incarnate Word', 'Texas-San Antonio'] },
    ...
    { name: 'Louisiana vs Missouri', teams: ['Louisiana', 'Missouri'] },
    ...
    { name: 'Middle Tennessee State vs Nevada', teams: ['Middle Tennessee State', 'Nevada'] },
    { name: 'Minnesota vs California', teams: ['Minnesota', 'California'] },
    { name: 'Monmouth vs Charlotte', teams: ['Monmouth', 'Charlotte'] },
    ...
    { name: 'South Florida vs Miami (FL)', teams: ['South Florida', 'Miami (FL)'] },
    ...
    { name: 'Southern Methodist vs Missouri State', teams: ['Southern Methodist', 'Missouri State'] },
    { name: 'Texas A&M vs Notre Dame', teams: ['Texas A&M', 'Notre Dame'] },
    { name: 'Texas State vs Arizona State', teams: ['Texas State', 'Arizona State'] },
    { name: 'Texas-El Paso vs Texas', teams: ['Texas-El Paso', 'Texas'] },
